(function ($) {
	...
	///*------------Toogle for login/register------------------ */

	function toggleSignup()
	{
		document.getElementById("login-toggle").style.backgroundColor="#fff";
		document.getElementById("login-toggle").style.color="#e72463";
		document.getElementById("signup-toggle").style.backgroundColor="#e72463";
	...
	{
		document.getElementById("login-toggle").style.backgroundColor="#e72463";
		document.getElementById("login-toggle").style.color="#fff";
		document.getElementById("signup-toggle").style.backgroundColor="#fff";
		document.getElementById("signup-toggle").style.color="#e72463";
